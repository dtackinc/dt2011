...
#include <wrangler.h>
DT_RCSID("app/wrangler $RCSfile: verify.c,v $ $Revision: 1.8 $");
  ...
  if (n != 5 && n != 4)
	return dt_err(ctl, F,
      ...
      ipc->client_spec, n);
										...
										/* ................................ */
  p = strchr(wrangler->parent_spec, ',');
  n = sscanf(p? p+1: wrangler->parent_spec,
    "%d.%d.%d.%d:%d",
    &v1, &v2, &v3, &v4, 
    &vport);
  if (n != 5 && n != 4)
