...
#include <netchat.h>
DT_RCSID("app/netchat $RCSfile: converse.c,v $ $Revision: 1.8 $");
#include <dtack/str.h>
  ...
  const char *listener_ident)
{
  ...
  DT_C(netchat_ask,(netchat,			/* start listener streaming			*/
  ...
  DT_C(netchat_ask,(netchat,			/* start talker streaming			*/
