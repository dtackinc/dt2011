...
#include <dtack/config.h>					/* platform-specific includes		*/
#include <dtack/ntype.h>					/* scalar data types 				*/
#include <dtack/stats.h>					/* stats structure 					*/
#include <dtack/1d.h>

#ifdef DTCONFIG_WANT_STATIC_RCSID
#	define DT_RCSID(RCSID) static char rcsid[] = RCSID
#	define DT_RCSID_STRING rcsid
#else
