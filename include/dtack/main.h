...
/*..........................................................................
  CHANGES
  20000104 DE proper initialization of structures for egcs
  19990206 DE cleanup console macro
  19990124 DE added rwd (remove-when-done) logic
  19981214 DE int main
...
#define DTMAIN_NAME(F)														  \
  ...
  {																			  \
	...
	l = DT_MIN(strlen(pslash), sizeof(F)-1);		/* 2006-04-06 bug!      */\
	for (i=0; i<l; i++)														  \
...
#define DTMAIN1(PROG)                                                        \
  ...
  {                                                                          \
    ...
    dtmsw_t msw;                                                             \
    dt_rc_e rc;                                                              \
    DT_MEMSET(param, 0, sizeof(*param));                                     \
    DT_MEMSET(&msw, 0, sizeof(msw));                                         \
    ...
    rwd[0] = '\0';															 \
    if (argc > 0 && !strncmp(argv[0], "rwd=", 4))	  						 \
    {                                 										 \
      strcpy(rwd, argv[0]+4);												 \
      argv++;																 \
      argc--;																 \
