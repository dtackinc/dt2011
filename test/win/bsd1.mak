...
exes: \
	  $(OUT)/bin/dttwin$(MK_EXE)

shexes: \
	  $(OUT)/bin/dttwin$(MK_SHEXE)
...
#----------------------------------------------------------------------------
strip:
	if [ -w $(OUT)/bin/dttwin$(MK_SHEXE) ]; \
	  then $(MK_STRIP) $(OUT)/bin/dttwin$(MK_SHEXE); fi
	if [ -w $(OUT)/bin/dttwin$(MK_EXE) ]; \
	  then $(MK_STRIP) $(OUT)/bin/dttwin$(MK_EXE); fi



#----------------------------------------------------------------------------
clean:
	$(MK_RM) $(OUT)/bin/dttwin$(MK_SHEXE)
	$(MK_RM) $(OUT)/bin/dttwin$(MK_EXE)
	$(MK_RM) $(OUT)/test/win/*.o
	$(MK_RM) $(MK_JUNK)
...
$(OUT)/bin/dttwin$(MK_EXE): \
	  $(OUT)/test/win/dttwin.o \
	  $(OUT)/test/win/dttwinx.o \
	...
	$(MK_LD) $(MK_LDDEBUGGER_ON) $(MK_LDSTACK_SMALL) $(MK_LDSHARABLE_OFF) -o $(OUT)/bin/dttwin$(MK_EXE) \
	  $(OUT)/test/win/dttwin.o \
	  $(OUT)/test/win/dttwinx.o \
	  -L$(OUT)/lib -ldtwins \
	  -L$(OUT)/lib -ldttaa \
...
$(OUT)/bin/dttwin$(MK_SHEXE): $(OUT)/test/win/dttwin.o \
	  $(OUT)/test/win/dttwinx.o
	$(MK_LD) $(MK_LDDEBUGGER_ON) $(MK_LDSTACK_SMALL) $(MK_LDSHARABLE_ON) -o $(OUT)/bin/dttwin$(MK_SHEXE) \
	  $(OUT)/test/win/dttwin.o \
	  $(OUT)/test/win/dttwinx.o  \
	  -L$(OUT)/libso -ldtwins \
	  -L$(OUT)/libso -ldttaa \
...
$(OUT)/test/win/dttwin.o: $(SRC)/test/win/dttwin.c \
	...
	$(MK_CC) -c -o $(OUT)/test/win/dttwin.o $(MK_CCSHARABLE_OFF) $(MK_CCEXCEPTION_OFF) $(MK_CCDEBUGGER_ON) $(MK_CCOPTIMIZE_NONE) \
	   $(MK_CCWARNINGS_HIGH) \
	  -D$(MK_DTCONFIG_TARGET) -DDTPRJ_NOPAGING=DT_$(MK_PRJ_NOPAGING) \
	  -I$(SRC)/test/win \
	  -I$(SRC)/include \
	  $(SRC)/test/win/dttwin.c
$(OUT)/test/win/dttwinx.o: $(SRC)/test/win/dttwinx.c \
	  $(SRC)/include/dtack/t.h \
	  $(SRC)/include/dtack/base.h \
	  $(SRC)/include/dtack/config.h \
	  $(SRC)/include/dtack/ntype.h \
	  ...
	  $(SRC)/test/win/dttwin.use
	$(MK_CC) -c -o $(OUT)/test/win/dttwinx.o $(MK_CCSHARABLE_OFF) $(MK_CCEXCEPTION_OFF) $(MK_CCDEBUGGER_ON) $(MK_CCOPTIMIZE_NONE) \
	   $(MK_CCWARNINGS_HIGH) \
	  -D$(MK_DTCONFIG_TARGET) -DDTPRJ_NOPAGING=DT_$(MK_PRJ_NOPAGING) \
	  -I$(SRC)/test/win \
	  -I$(SRC)/include \
	  $(SRC)/test/win/dttwinx.c
