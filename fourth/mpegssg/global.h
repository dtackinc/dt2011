...
/* getpic.c */
int Decode_Picture _ANSI_ARGS_((int bitstream_framenum, 
  int sequence_framenum));
...
/* store.c */
int Write_Frame _ANSI_ARGS_((unsigned char *src[], int frame));

/* display.c */
int Initialize_Display_Process _ANSI_ARGS_((char *name));
void Terminate_Display_Process _ANSI_ARGS_((void));
void Display_Second_Field _ANSI_ARGS_((void));
int dither _ANSI_ARGS_((unsigned char *src[]));
