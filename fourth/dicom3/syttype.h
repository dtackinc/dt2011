...
/* syttype.h 0.12 95/09/18 Copyright (C) 1993,1994,1995. David A. Clunie. All rights reserved. */

#ifndef _DC3syttype_HEADER_
#define _DC3syttype_HEADER_
...
class SYTEC_float32 {
	...
	char		*toString(void);
public:
	SYTEC_float32(unsigned l)
		{
			if (l != 1) {
				cerr << "SYTEC:: Only length 1 supported, not "
				     << l << "\n" << flush;
			}
			sh=0;
		}
