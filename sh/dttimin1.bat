...
dtutil time %1: being started by dttimin1.bat _date_ _time_
dtutil time %1: being started by dttimin1.bat _date_ _time_>> %2\timing.out
...
rem # timing.out, but not reported as an error by "dtutil endcheck".
...
call %2\tmp\tmp.bat %4 %5 %6 %7 -D %DT_D% -op time

rem # Concatenate output from program run to master timing.out file.
type %2\tmp\tmp.out >> %2\timing.out

goto bottom
rem =====================================================
:badarg1
echo dttimin.bat: missing test name argument
goto bottom
rem =====================================================
:badarg2
echo dttimin.bat: missing OUT directory name argument
goto bottom
rem =====================================================
:badarg 3
echo dttimin.bat: missing executable name argument
goto bottom
